...
# Widget
# --------------------------------------------------------------------------------------------------
class MovementControl(HelpGroupBox):
    ...
    def __init__(
        ...
        super().__init__("Movement Control", "movement-control", parent)
        ...
        self._home_all_axes_button = QPushButton("Home", self.content_group_box)
        self._home_all_axes_button.clicked.connect(self._home_all_axes)
        layout.addWidget(self._home_all_axes_button, 0, 0, 1, 3)
        self._set_origin_button = QPushButton(
            "Set Current Position as Origin",
            self.content_group_box,
        )
        ...
        layout.addWidget(QLabel("Movement type", self.content_group_box), 2, 0)
        layout.addWidget(QLabel(":", self.content_group_box), 2, 1)
        self._movement_type_selector = QComboBox(self.content_group_box)
        ...
        for row_index, (axis, selector) in enumerate(
            ...
            layout.addWidget(QLabel(axis, self.content_group_box), row_index, 0)
            layout.addWidget(QLabel(":", self.content_group_box), row_index, 1)
            layout.addWidget(selector, row_index, 2)
        layout.addWidget(QLabel("Speed", self.content_group_box), 6, 0)
        layout.addWidget(QLabel(":", self.content_group_box), 6, 1)
        ...
        self._send_movement_button = QPushButton(
            "Send Movement",
            self.content_group_box,
        )
